package com.khanhtq.prosoccerteam.adapter;
 ...
 */
public class ArenaTeamInfoWindowAdapter extends TeamInfoWindowAdapter {

    public ArenaTeamInfoWindowAdapter(Activity activity) {
        super(activity);
    }
