package com.khanhtq.prosoccerteam.items;
...
public class Team {
    ...
    public Team(String name, LatLng address, String description, String webAddress, String wikiAddress, int iconDrawable) {
        mName = name;
        mAddress = address;
